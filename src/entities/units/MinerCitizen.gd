## MinerCitizen.gd
## Citizen type: miner. Works at a Quarry building and travels to
## nearby rocks to mine them, yielding stone.
##
## BT structure is identical to LumberjackCitizen — see that file for
## the full tree diagram. Only the target type differs ("rock" vs "tree").
class_name MinerCitizen
extends Citizen
...
func _load_phase_colors(cfg: Dictionary) -> void:
	var fallback: String = cfg.get("miner_work_color", "#8c8c8c")
